...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(AbstractHttpConfigurer::disable) // Disables CSRF protection
                ...
                .authorizeHttpRequests(request -> request //TODO: Add Educator and Moderator requestMatchers
                        .requestMatchers("/auth/**", "/public/**").permitAll() // Allows access to /auth/** and /public/** without authentication
                        ...
                        .requestMatchers("/adminuser/**").hasAnyAuthority("ADMIN", "USER") // Requires ADMIN or USER authority for /adminuser/** paths
